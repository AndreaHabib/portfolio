        ...
        <div className="interns">
          <div>
            ...
            <p>
              ...
              various tech stacks to help decrease panic associated with
              COVID-19 pandemic crisis. Worked on a client project called
              Discourse.
            </p>
            <ul style={{ textAlign: "left" }}>
              ...
              <li>
                ...
                Subsystem for Linux resulting in the ability of using Discourse
                on Windows 10
              </li>
              <li>
            ...
            <ul style={{ textAlign: "left" }}>
              ...
              <li>
                ...
                by using PostgreSQL, Express.js, React.js, and Node.js (PERN)
                tech stacks to build an application that shows a map of covid
                cases in your area.
              </li>
              <li>
              ...
              <li>
                Used Git/GitHub for version control and created a workflow with
                my team.
              </li>
            </ul>
