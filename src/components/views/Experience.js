  ...
  render() {
    return (
      <section>
        ...
        <h6>
          Worked in an agile environment where I engaged in daily stand ups and
          weekly sprint retrospectives. Worked on MLH hackathon and used various
          tech stacks to help decrease panic associated with COVID-19 pandemic
          crisis. Worked on a client project called Discourse.
        </h6>
        <ul style={{ textAlign: "left" }}>
          ...
          <li>
            Applied Ember.js to fix UI issues that were preventing sorting text
            from showing up, and create a modal to prompt a warning to the user
            if they click the delete button on a post.
          </li>
          <li>
        ...
        <ul style={{ textAlign: "left" }}>
          ...
          <li>
            Led a team of 3 developers and won 1st place in an MLH Hackathon by
            using PostgreSQL, Express.js, React.js, and Node.js (PERN) tech
            stacks to build an application that shows a map of covid cases in
            your area.
          </li>
          <li>
            Frontend responsibility - Used React.js, Javascript and Google Maps
            API to show the map with the cases on the frontend
          </li>
          <li>
            Database responsibility - Used PostgreSQL to store user information
            through login and register in the database
          </li>
          <li>
        ...
        <ul style={{ textAlign: "left" }}>
          <li>
            ...
            that allows a user to look up different video games and add them to
            their favorites on their account.
          </li>
          <li>
          ...
          <li>
            Used Axios for HTTP POST requests from API to search for video games
            and add them to favorites page using PostgreSQL, Express.js and
            Sequelize
          </li>
          <li>
